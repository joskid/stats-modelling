...
price_data <- read.csv("historical_data.csv", header = TRUE, sep = ";")
...
brent_data <- read.csv("brent_projection.csv", header = TRUE, sep = ",")
...
i. assuming that all figures in Table 4 reflect the prices in December of the respective year, and
ii. linearly interpolating values (i.e. drawing straight lines) between the December prices.
...
i. the fitted values mimic the observed HSFO prices almost perfectly, and
ii. the predicted values are able to capture the general movement of the observed HSFO prices.
...
```{r backtesting, results = "hide", fig.height = 4, fig.width = 10, fig.cap = "Fig.5 Model fit and back-testing result on historical data (1 Nov 2011 - 19 Sep 2017)", fig.align = "center"}
